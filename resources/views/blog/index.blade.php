        ...
        <div class="tealinux-screen-section tealinux-white-space mdl-typography--text-center">
            ...
            <div class="mdl-grid">
              ...
              <div class="mdl-cell mdl-cell--8-col mdl-cell--4-col-phone">
                <p class="mdl-typography--font-light ">
                    TeaLinuxOS adalah distro Linux turunan Ubuntu yang dikembangkan oleh <a href="http://doscom.org" style="color:#2196F3;text-decoration: none;">Dinus Open Source Community (DOSCOM)</a>  yang berorientasi pemrograman. Dengan menghadirkan filosofi, “Nikmatnya sebuah racikan”, TeaLinuxOS dikembangkan secara terbuka dan bersama-sama untuk menghasilkan distro Linux pemrograman yang dikhususkan untuk dunia pendidikan.
                </p>
              </div>
              <div class="mdl-cell mdl-cell--2-col mdl-cell--4-col-phone"></div>
            </div>
            ...
            <div class="mdl-grid tealinux-slogan">
                ...
                <div class="mdl-cell mdl-cell--3-col mdl-cell--12-col-phone">
                    ...
                    <h4>High Qualitea</h4>
                    <p class="mdl-typography--font-light"> Berangkat dari dukungan dari semua pihak sistem operasi ini mengalami penyempurnaan mejadi sistem operasi yang stabil dan berkualitas.</p>
                </div>
                <div class="mdl-cell mdl-cell--3-col mdl-cell--12-col-phone">
                    <span class="icon-globe-alt slogan-icon" aria-hidden="true"></span>
                    <h4>Communitea</h4>
                    <p class="mdl-typography--font-light">Dukungan kuat dari forum dan komunitas dunia virtual maupun komunitas riil menjadikan sistem operasi ini berkembang cepat.</p>
                </div>
                <div class="mdl-cell mdl-cell--3-col mdl-cell--12-col-phone">
                    <span class="icon-chemistry slogan-icon" aria-hidden="true"></span>
                    <h4>Nutriteaon</h4>
                    <p class="mdl-typography--font-light">Dukungan yang kuat dan tersedianya repository yang lengkap menjadikan sistem operasi ini penuh nutrisi.</p>
                </div>
            </div>
