        ...
        <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
            <header class="mdl-layout__header tealinux-header">
              ...
              <span class="tealinux-title mdl-layout-title">
                <a href="{{ url('/') }}" ><img class="tealinux-logo-image" src="{{asset ('images/tealinuxos.png')}}">
                <span class="tealinux-page-title mdl-typography--text-uppercase">tealinuxos</span></a>
                    ...
                    <div class="tealinux-navigation-container">
                        <nav class="tealinux-navigation mdl-navigation">
                            <a class="mdl-navigation__link mdl-typography--text-uppercase mdl-js-ripple-effect" href="{{url ('/')}}">Beranda</a>
                            <a class="mdl-navigation__link mdl-typography--text-uppercase" href="{{url ('dukungan')}}">dukungan</a>
                            <a class="mdl-navigation__link mdl-typography--text-uppercase" href="{{url ('kontribusi')}}">Kontribusi</a>
                            <a class="mdl-navigation__link mdl-typography--text-uppercase" href="{{url ('blog')}}">Blog</a>
                            <a class="mdl-navigation__link mdl-typography--text-uppercase" href="{{url ('lapor')}}">Lapor</a>
                            <a class="mdl-navigation__link mdl-typography--text-uppercase open " style="cursor:pointer;">Unduh</a>
                    ...
                    <ul class="mdl-menu mdl-js-menu mdl-menu--bottom-right mdl-js-ripple-effect" for="more-button">
                        <li class="mdl-menu__item"> <a class="mdl-navigation__link" href="{{url ('/')}}">Beranda</a> </li>
                        <li class="mdl-menu__item"> <a class="mdl-navigation__link" href="{{url ('dukungan')}}">Dukungan</a> </li>
                        <li class="mdl-menu__item"> <a class="mdl-navigation__link" href="{{url ('kontribusi')}}">Kontribusi</a> </li>
                        <li class="mdl-menu__item"> <a class="mdl-navigation__link" href="{{url ('blog')}}">Blog</a> </li>
                        <li class="mdl-menu__item"> <a class="mdl-navigation__link" href="{{url ('lapor')}}">Lapor</a> </li>
                        <li class="mdl-menu__item"> <a class="mdl-navigation__link open " style="cursor:pointer;">Unduh</a> </li>
                    </ul>
