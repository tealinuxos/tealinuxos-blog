...
class EnBugController extends Controller {
	...
	public function index()
	{
		...
		return view('en.blog.reportall')->withBugs($bugs);
	}

	public function desktop(){
		$bugs = Bugs::paginate(7);
		return view('en.blog.desktop')->withBugs($bugs);
	}
	...
	public function desktopstore(Request $request)
	{
		...
		return redirect('en/desktop/lapor/terimakasih')->withMessage($message);
	}
	public function desktoplist(){
		$bugs = Bugs::paginate(7);
		return view('en.blog.listdesktop')->withBugs($bugs);

	}
	public function showlist($slug)
	{
		$bug = Bugs::where('slug',$slug)->first();
		return view('en.blog.readmorelist')->withBug($bug);
	}
	...
	{
		$bug = Bugs::paginate(7);
		return view('en.blog.report')->withBug($bug);
	}
	...
	public function store(Request $request)
	{
		...
		$message = 'Laporan sudah terkirim';
		return redirect('en/lapor/terimakasih')->withMessage($message);
	}
	...
	public function show($slug)
	{
		...
		return view('en.blog.readmorebug')->withBug($bug);
	...
	public function edit($id)
	{
		...
		return view('en.blog.editlapor')->withBug($bug);
	}
